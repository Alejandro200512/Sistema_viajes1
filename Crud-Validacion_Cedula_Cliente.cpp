...
struct Cliente {
    ...
    //Justificacion: La cedula ecuatoriana puede comenzar con el digito 0, si se almacena como un int, el digito 0 inicial se pierde automaticamente, esto genera errores al validar o mostrar la cedula
...
void crearPaquete() {
    ...
    //Solicitar la cedula del cliente
	cout << "Ingrese su cédula: ";
	cin >> cliente.cedula;
	
	while (!cedulaValida(cliente.cedula)) {
	    cout << "Cédula inválida. Debe tener 10 números y un código de provincia válido (01-24 o 30 si es extranjero): ";
	    cin >> cliente.cedula;
	}
